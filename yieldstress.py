...
highRate=[1000,2000,3000,4000]
highRateStress=[get1000RateDate()[1][0],get2000RateDate_fit()[1][0],get3000RateDate()[1][0],get4000RateDate()[1][0]]
...
def yieldmodel():
    ...
    popt, pcov=curve_fit(f,x,y,bounds=([0,0,0],[np.inf,np.inf,20]),maxfev=5000000)
    coe1,coe2,coe3= popt
...
if __name__=='__main__':
    strainpre = [0.001, 0.01, 0.1, 1, 10, 100, 200, 300, 500, 800] + [1000,1100,1200,1500,1800,2000,2200,2500,2800,3000,5000]
    strainRateX = [0.001, 0.01, 0.1] + highRate
    stressy = [stress20[0], 121.8, 122] + highRateStress
